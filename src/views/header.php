        ...
        <div class="margin">
          ...
          <nav>
            <ul>
              ...
              <?php } ?>
              <li class="search <?php echo Utility::isActiveTab('search') ? 'on' : ''; ?>">
                <a href="#" class="search-bar-toggle"><img src="/assets/img/default/header-navigation-search.png" align="absmiddle">Search</a>
                <div id="searchbar">
                  <form method="get" id="form-tag-search">
                    <input type="text" name="tags" value="Enter a tag" class="select"> &nbsp; <button type="submit">Search</button>
                  </form>
                </div>
              </li>
            </ul>
