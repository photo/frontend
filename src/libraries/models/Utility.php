...
class Utility
{
  ...
  public function staticMapUrl($latitude, $longitude, $zoom, $size, $type = 'roadmap', $write = true)
  {
    ...
    switch ($service) {
    case "osm":
        return $this->returnValue("http://staticmap.openstreetmap.de/staticmap.php?center={$latitude},{$longitude}&zoom={$zoom}&size={$size}&markers={$latitude},{$longitude},ol-marker", $write);
    case "google":
    default:
