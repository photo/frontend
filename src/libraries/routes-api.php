...
$apiObj->post('/?v?[1-2]?/photo/([a-zA-Z0-9]+)/purge.json', array('ApiPhotoController', 'purge'), EpiApi::external); // purge a photo (/photo/{id}/delete.json)
...
$apiObj->post('/?v?[1-2]?/photo/([a-zA-Z0-9]+)/restore.json', array('ApiPhotoController', 'restore'), EpiApi::external); // restore a photo (/photo/{id}/delete.json)
