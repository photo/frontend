...
OPU=function(){return{init:function(){var l=$("#uploader");l.length!=0&&(l.pluploadQueue({runtimes:"html5",url:"/photo/upload.json",max_file_size:"20mb",unique_names:true,filters:[{title:"Photos",extensions:"jpg,jpeg,gif,png"}],flash_swf_url:"plupload.flash.swf",multipart_params:{crumb:$("form.upload input.crumb").val()},preinit:{BeforeUpload:function(){var h=$("#uploader").pluploadQueue();$(".upload-progress .total").html(h.files.length);$(".upload-progress .completed").html(h.total.uploaded+1);
