(function(){Storage.prototype.setObject=function(b,a){this.setItem(b,JSON.stringify(a))};Storage.prototype.getObject=function(b){return(b=this.getItem(b))&&JSON.parse(b)};var e=OP.Util.constructor.prototype,d=function(b){typeof console!=="undefined"&&console.log(b)};OP.Batch=new function(){var b=this;this._callbackAdd=function(a){a=a.result;b.collection.add(a.id,a);OP.Util.fire("callback:batch-add",a)};this.add=function(a){var c={};arguments.length>1&&(c=arguments[1]);d("[Util][Batch] adding "+a);
