...
OP.Util.fire("callback:tags-updated")}};this.init=function(c){c=c||!1;a=localStorage.getObject("tags")||null;b=parseInt(localStorage.getItem("tags-lastModified"))||0;c||null===a||b<e()-1800?OP.Util.makeRequest("/tags/list.json",{},d,"json","get"):OP.Util.fire("callback:tags-initialized")};this.getTags=function(){return a}}})();
