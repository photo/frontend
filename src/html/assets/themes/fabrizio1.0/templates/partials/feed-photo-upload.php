<li class="type-<?php $this->utility->safe($activity[0]['type']); ?>">
  ...
  <img class="to" src="<?php $this->utility->safe($this->user->getAvatarFromEmail(50, $activity[0]['owner'])); ?>" alt="<?php $this->utility->safe($this->user->getNameFromEmail($activity[0]['owner'])); ?>" />
