...
/* 05-gallery.min.js */
var Gallery=function(f){var i=0,k=function(d,a){return void 0===typeof d||null==d?a:d},l=function(d){var a={href:d},d=d.replace("//","/").split("/");a.protocol=d[0];a.host=d[1];d[1]=d[1].split(":");a.hostname=d[1][0];a.port=1<d[1].length?d[1][1]:"";d.splice(0,2);a.pathname="/"+d.join("/");a.pathname=a.pathname.split("#");a.hash=1<a.pathname.length?"#"+a.pathname[1]:"";a.pathname=a.pathname[0];a.pathname=a.pathname.split("?");a.search=1<a.pathname.length?"?"+a.pathname[1]:"";a.pathname=a.pathname[0];
return a},m=function(d,a){var e=[],c=0;0<i&&(d=i);for(i=d;0<a.length&&c<d;){var b=a.shift();e.push(b);c+=b.photo960x180[1]+6}b=c-d;if(0<e.length&&0<b){var j=c,c=[],g=0,h;for(h in e)c[h]=Math.floor(e[h].photo960x180[1]/j*b),g+=c[h];for(b-=g;0<b;)for(h in c)if(c[h]++,b--,0==b)break;for(var f in e)h=c[f],b=e[f],b.vx=Math.floor(h/2),b.vwidth=b.photo960x180[1]-h,i-=b.vwidth+6}else for(f in e)b=e[f],b.vx=0,b.vwidth=b.photo960x180[1],i-=b.vwidth+6;return e},n=function(d,a){var e=opTheme.init.pages.photos,
c=e.pageLocation.search.replace(/(page|returnSizes)=[^&?]+\&?/g,""),b=f('<div class="imageContainer"/>'),j=f("<div/>");j.css("width",""+k(a.vwidth,120)+"px");j.css("height",""+k(a.path960x180[1],120)+"px");j.css("overflow","hidden");var g=l(a.url);null!==e.filterOpts&&0<e.filterOpts.length&&(g.pathname=0===c.length?g.pathname+"/"+e.filterOpts:g.pathname.replace("?","/"+e.filterOpts+"?"));e=f("<a/>");e.attr("href",g.pathname+c);c=f("<img/>");c.attr("src",a.path960x180);c.attr("class","photo-view-modal-click");
c.attr("title",a.title);c.css("width",""+k(a.path960x180[1],120)+"px");c.css("height",""+k(a.path960x180[2],120)+"px");c.css("margin-left",""+(a.vx?-a.vx:0)+"px");c.css("margin-top","0px");c.hide();e.append(c);j.append(e);b.append(j);c.bind("load",function(){f(this).fadeIn(400)});d.append(b);return parseInt(b.width())};return{showImages:function(d,a){for(var e=d.width()-1,c=a.slice(),b=[];0<c.length;)b.push(m(e,c));for(var f in b)for(var g in b[f])n(d,b[f][g])}}}(jQuery);
