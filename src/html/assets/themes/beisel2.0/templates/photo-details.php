    ...
    <ul class="image-pagination">
      ...
      <li class="previous">
        <a href="<?php $this->url->photoView($photo['previous']['id'], $options); ?>" title="Go to previous photo" class="thumb">
          <img src="<?php $this->url->photoUrl($photo['previous'], $this->config->photoSizes->nextPrevious); ?>" alt="Go to previous photo" class="photo-view-click previous-photo" />
      ...
      <li class="next">
        <a href="<?php $this->url->photoView($photo['next']['id'], $options); ?>" title="Go to next photo" class="thumb">
          <img src="<?php $this->url->photoUrl($photo['next'], $this->config->photoSizes->nextPrevious); ?>" alt="Go to next photo" class="photo-view-click next-photo" />
