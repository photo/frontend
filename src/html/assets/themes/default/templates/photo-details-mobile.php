    ...
    <div class="photo-details">
      <div class="image-pagination">
        <?php if(!empty($photo['previous'])) { ?>
          <div class="previous">
            <a href="<?php $this->url->photoView($photo['previous']['id'], $options); ?>" style="background:url(<?php $this->url->photoUrl($photo['previous'], $this->config->photoSizes->nextPrevious); ?>) top left no-repeat;" data-direction="reverse"><span class="audible">Go to previous photo</span></a>
          </div>
        <?php } else { ?>
          <div class="empty"></div>
        <?php } ?>
